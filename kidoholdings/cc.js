...
CookieConsentDialog.lastUpdatedDate = 1609831341500;
CookieConsentDialog.cookieTableNecessary = [["bSession", "kidoholdings.com", "Registers which server-cluster is serving the visitor. This is used in context with load balancing, in order to optimize user experience.  ", "1 day", "HTTP", "1", "", "static.parastorage.com"], ["CookieConsent", "kidoholdings.com", "Stores the user\'s cookie consent state for the current domain", "1 year", "HTTP", "1", "", "cookiebot.com"], ["hs", "kidoholdings.com", "Ensures visitor browsing-security by preventing cross-site request forgery. This cookie is essential for the security of the website and visitor.   ", "Session", "HTTP", "1", "", "www.kidoholdings.com"], ["ssr-caching", "kidoholdings.com", "This cookie is necessary for the cache function. A cache is used by the website to optimize the response time between the visitor and the website. The cache is usually stored on the visitor’s browser.", "1 day", "HTTP", "1", "", "www.kidoholdings.com"], ["XSRF-TOKEN", "kidoholdings.com", "Ensures visitor browsing-security by preventing cross-site request forgery. This cookie is essential for the security of the website and visitor.   ", "Session", "HTTP", "1", "", "www.kidoholdings.com"], ["JSESSIONID", "nr-data.net", "Preserves users states across page requests.", "Session", "HTTP", "1", "", "nr-data.net"], ["unique_id", "powr.io", "Preserves users states across page requests.", "Session", "HTTP", "1", "", "powr.io"], ["wix_premium_user", "powr.io", "Registers whether the user is logged in. This allows the website owner to make parts of the website inaccessible, based on the user\'s log-in status.  ", "Session", "HTTP", "1", "", "powr.io"], ["TS#", "kidoholdings.com", "Pending", "Session", "HTTP", "1", "^TS[0-9a-z_]{8}_*[0-9a-z]{0,4}$", "www.kidoholdings.com"]];
CookieConsentDialog.cookieTablePreference = [];
CookieConsentDialog.cookieTableStatistics = [["fedops.logger.sessionId", "kidoholdings.com", "Registers statistical data on users\' behaviour on the website. Used for internal analytics by the website operator. ", "Persistent", "HTML", "2", "", "static.parastorage.com"], ["ahoy_visit", "powr.io", "Registers statistical data on users\' behaviour on the website. Used for internal analytics by the website operator. ", "1 day", "HTTP", "1", "", "powr.io"], ["ahoy_visitor", "powr.io", "Registers statistical data on users\' behaviour on the website. Used for internal analytics by the website operator. ", "2 years", "HTTP", "1", "", "powr.io"], ["src", "powr.io", "Detects how the user reached the website by registering their last URL-address.", "30 days", "HTTP", "1", "", "powr.io"]];
CookieConsentDialog.cookieTableAdvertising = [["svSession", "kidoholdings.com", "Tracks a visitor across all wix.com sites. The information collected can be used to make advertisement more relevant for the visitor. ", "2 years", "HTTP", "1", "", "www.kidoholdings.com"], ["POWR_PRODUCTION", "powr.io", "Used in context with pop-up advertisement-content on the website. The cookie determines which ads the visitor should be shown, as well as ensuring that the same ads does not get shown more than intended.", "Session", "HTTP", "1", "", "powr.io"]];
CookieConsentDialog.cookieTableUnclassified = [["events/1/#", "bam.nr-data.net", "Pending", "Session", "Pixel", "5", "", "bam.nr-data.net"], ["ahoy_unique_24515231", "powr.io", "Pending", "1 day", "HTTP", "1", "", "powr.io"], ["editables", "powr.io", "Pending", "Session", "HTTP", "1", "", "powr.io"]];
CookieConsentDialog.cookieTableNecessaryCount = 9;
CookieConsentDialog.cookieTablePreferenceCount = 0;
CookieConsentDialog.cookieTableStatisticsCount = 4;
CookieConsentDialog.cookieTableAdvertisingCount = 2;
CookieConsentDialog.cookieTableUnclassifiedCount = 3;
CookieConsent.whitelist = ['bSession', 'CookieConsent', 'hs', 'ssr-caching', 'XSRF-TOKEN', 'JSESSIONID', 'unique_id', 'wix_premium_user', 'TS#'];
CookieConsentDialog.privacyPolicies = [['bam.nr-data.net', 'New Relic', 'https://newrelic.com/termsandconditions/services-notices'], ['cookiebot.com', 'Cookiebot', 'https://www.cookiebot.com/goto/privacy-policy/'], ['nr-data.net', 'New Relic', 'https://newrelic.com/privacy'], ['powr.io', 'Powr', 'https://www.powr.io/privacy'], ['static.parastorage.com', 'Wix.com', 'http://parastorage.com/']];
