(CookieControl.Dialog = function (e, o, t, i, n, s, l, a, r, d, c, C, y, h, g, p, u, m, k, b, B, f, D) {
    ((that = this).name = "CybotCookiebotDialog"),
        ...
        (this.templates = { top: "", bottom: "", slidedown: "", pushdown: "", slideup: "", overlay: "", popup: "", custom: "" }),
        (this.themes = { white: "", dark: "", customcolor: "" }),
        (this.styles = { top: "", bottom: "", slidedown: "", pushdown: "", slideup: "", overlay: "", popup: "", custom: "" }),
        (this.modes = {
            top_white: "",
            top_dark: "",
            top_customcolor: "",
        ...
        (this.customColors = { background: "", text: "", acceptbutton: "", selectionbutton: "", declinebutton: "", buttontext: "", tab: "", border: "", logo: "" }),
        (this.customImages = { showdetails: "", hidedetails: "", cbCheckedNofocus: "", cbCheckedFocus: "", cbCheckedDisabled: "", cbNotCheckedFocus: "", cbNotCheckedNoFocus: "" }),
        (this.customTemplateDef = { HTML: "", CSS: "", Script: "", FunctionShowName: "", FunctionHideName: "" }),
        (this.prechecked = { preferences: !0, statistics: !0, marketing: !0 }),
        (this.optionaloptinSettings = { displayConsentBanner: !1 }),
        (this.IABSettings = { purposes: [], specialpurposes: [], features: [], specialfeatures: [], stacks: [], vendors: [], version: "", lastupdated: "" }),
        (this.IABGVL = null),
    ...
    (CookieControl.Dialog.prototype.getCookieTableHTML = function (e, o, t, i) {
                ...
                if (((a.innerHTML = o[s][j]), 0 == j)) {
                    ...
                    if ((7 < o[s].length && (d = o[s][7].split("<br/>")), 1 < d.length)) {
                        for (var c = "", C = [], y = 0; y < d.length; y++) {
                            ...
                            -1 == C.indexOf(h) && (C.push(h), (c += h), y < d.length - 1 && (c += "<br/>"));
                        }
                        a.innerHTML = c;
        ...
        if (0 == o.length) {
            ...
            (n.style.textAlignment = i), (n.innerHTML = this.noCookiesTypeText), (n.className = "CybotCookiebotDialogDetailBodyContentCookieTypeTableEmpty");
        }
        ...
        if (0 < this.privacyPolicies.length)
            for (i = 0; i < this.privacyPolicies.length; i++)
                if (this.privacyPolicies[i][0] == e) {
                    o =
                        '<a href="' +
                        this.privacyPolicies[i][2] +
                        '" target="_blank" rel="noopener noreferrer nofollow" title="' +
                        this.privacyPolicyText.replace("{0}", this.privacyPolicies[i][1]).replace("'", "'") +
                        '">' +
                        this.privacyPolicies[i][1] +
                        "</a>";
                    break;
                }
        return o;
    ...
    (CookieControl.Dialog.prototype.init = function () {
        ...
        e.initEvent("CookiebotOnDialogInit", !0, !0),
            ...
            window.dispatchEvent(e),
            !this.mode in this.modes && ((this.mode = "slidedown_dark"), (this.theme = "dark"), (this.template = "slidedown")),
            0 < this.mode.indexOf("_") && ((this.template = this.mode.split("_")[0]), (this.theme = this.mode.split("_")[1])),
            this.clearDOM(),
        ...
        (e.innerHTML = o
            ...
            .replace(/\[#LOGO#]/g, this.logo)
            .replace(/\[#LOGOALT#]/g, this.logoAltText)),
            "" != this.bulkconsentDomainsString
                ? (e.innerHTML = e.innerHTML
                      .replace(/\[#COOKIESGENERALINTRO#]/g, this.cookieIntroText.replace(/\n/g, "") + "<br><br>" + this.bulkconsentDomainsString + "<br><br>")
                      .replace(/\[#COOKIETYPEINTRO_NECESSARY#]/g, this.cookieIntroTypeNecessary.replace(/\n/g, ""))
                      .replace(/\[#COOKIETYPEINTRO_PREFERENCE#]/g, this.cookieIntroTypePreference.replace(/\n/g, ""))
                      .replace(/\[#COOKIETYPEINTRO_STATISTICS#]/g, this.cookieIntroTypeStatistics.replace(/\n/g, ""))
                      .replace(/\[#COOKIETYPEINTRO_ADVERTISING#]/g, this.cookieIntroTypeAdvertising.replace(/\n/g, ""))
                      .replace(/\[#COOKIETYPEINTRO_UNCLASSIFIED#]/g, this.cookieIntroTypeUnclassified.replace(/\n/g, "")))
                : (e.innerHTML = e.innerHTML
                      .replace(/\[#COOKIESGENERALINTRO#]/g, this.cookieIntroText.replace(/\n/g, ""))
                      .replace(/\[#COOKIETYPEINTRO_NECESSARY#]/g, this.cookieIntroTypeNecessary.replace(/\n/g, ""))
                      .replace(/\[#COOKIETYPEINTRO_PREFERENCE#]/g, this.cookieIntroTypePreference.replace(/\n/g, ""))
        ...
        if (void 0 !== this.userCulture && null != this.userCulture && void 0 !== this.lastUpdatedDate && null != this.lastUpdatedDate) {
            var t = { timeZone: "UTC", dateStyle: "short" },
                i = "",
        ...
        if (
            ((e.innerHTML = e.innerHTML
                ...
                .replace(/\[#LASTUPDATED#\]/g, o)
                .replace(/\[#COOKIETYPE_NECESSARY#\]/g, this.cookieHeaderTypeNecessary.replace("{0}", this.cookieTableNecessaryCount))
                .replace(/\[#COOKIETYPE_PREFERENCE#\]/g, this.cookieHeaderTypePreference.replace("{0}", this.cookieTablePreferenceCount))
                .replace(/\[#COOKIETYPE_STATISTICS#\]/g, this.cookieHeaderTypeStatistics.replace("{0}", this.cookieTableStatisticsCount))
                .replace(/\[#COOKIETYPE_ADVERTISING#\]/g, this.cookieHeaderTypeAdvertising.replace("{0}", this.cookieTableAdvertisingCount))
                .replace(/\[#COOKIETYPE_UNCLASSIFIED#\]/g, this.cookieHeaderTypeUnclassified.replace("{0}", this.cookieTableUnclassifiedCount))),
            (e.innerHTML = e.innerHTML
                .replace(/\[#COOKIETYPE_NECESSARY_RAW#\]/g, this.cookieHeaderTypeNecessary.replace(" ({0})", ""))
                .replace(/\[#COOKIETYPE_PREFERENCE_RAW#\]/g, this.cookieHeaderTypePreference.replace(" ({0})", ""))
                .replace(/\[#COOKIETYPE_STATISTICS_RAW#\]/g, this.cookieHeaderTypeStatistics.replace(" ({0})", ""))
                .replace(/\[#COOKIETYPE_ADVERTISING_RAW#\]/g, this.cookieHeaderTypeAdvertising.replace(" ({0})", ""))
                .replace(/\[#COOKIETYPE_UNCLASSIFIED_RAW#\]/g, this.cookieHeaderTypeUnclassified.replace(" ({0})", ""))),
            ...
            var s = e.innerHTML;
            s = (s = s.replace(/\[#IABV2SETTINGS#\]/g, this.IABResourceStrings.tabHeader))
                .replace(/\[#IABV2_LABEL_SETTINGS#\]/g, this.IABResourceStrings.settings)
                .replace(/\[#IABV2_LABEL_PURPOSES#\]/g, this.IABResourceStrings.purpose)
                .replace(/\[#IABV2_LABEL_FEATURES#\]/g, this.IABResourceStrings.feature)
                .replace(/\[#IABV2_LABEL_PARTNERS#\]/g, this.IABResourceStrings.partners);
            var l = "<div>" + this.IABResourceStrings.generalIntro + "<br/><br/>";
            "custom" == this.template
                ? (l += this.IABResourceStrings.legitimateInterestIntro.replace("<a>", "").replace("</a>", ""))
                : (l += this.IABResourceStrings.legitimateInterestIntro.replace("<a>", "<a href=\"javascript: CookieConsent.dialog.showCookieContainerIABv2DetailPane('partners');\">")),
                (l += "<br/><br/>" + this.IABResourceStrings.preferencesIntro + "</br></br></div>"),
                (l +=
                    "<div class='CybotCookiebotDialogBodyLevelButtonIABHeader'>" +
                    this.IABResourceStrings.purpose +
                    "<span class='CybotCookiebotDialogBodyLevelButtonIABHeaderToggle'><a href='javascript: CookieConsentDialog.IABSelectPurposes()'>" +
                    this.IABResourceStrings.selectAll +
                    "</a> | <a href='javascript: CookieConsentDialog.IABDeselectPurposes()'>" +
            ...
            var a = [];
            for (y in this.IABGVL.purposes) a.push(this.IABGVL.purposes[y].id);
            var r = [];
            for (y in this.IABGVL.specialPurposes) r.push(this.IABGVL.specialPurposes[y].id);
            var d = [];
            for (y in this.IABGVL.features) d.push(this.IABGVL.features[y].id);
            var c = [];
            for (y in this.IABGVL.specialFeatures) c.push(this.IABGVL.specialFeatures[y].id);
            ...
            if (CookieConsent.inlineConfiguration && null != CookieConsent.inlineConfiguration && CookieConsent.inlineConfiguration.Frameworks && CookieConsent.inlineConfiguration.Frameworks.IABTCF2) {
                if (
                    (CookieConsent.inlineConfiguration.Frameworks.IABTCF2.AllowedPurposes && (a = CookieConsent.inlineConfiguration.Frameworks.IABTCF2.AllowedPurposes),
                    ...
                    for (var y = 0; y < this.IABSortedVendorList.length; y++)
                        0 <= CookieConsent.inlineConfiguration.Frameworks.IABTCF2.AllowedVendors.indexOf(this.IABSortedVendorList[y]) && ((S = this.IABGVL.vendors[this.IABSortedVendorList[y]]), C.push(S.id));
                }
                for (y = 0; y < C.length; y++) {
                    if ((S = C[y]).specialPurposes && 0 < S.specialPurposes.length) for (var h = 0; h < S.specialPurposes.length; h++) r.indexOf(S.specialPurposes[h]) < 0 && r.push(S.specialPurposes[h]);
                    if (S.features && 0 < S.features.length) for (h = 0; h < S.features.length; h++) d.indexOf(S.features[h]) < 0 && d.push(S.features[h]);
                }
            }
            ...
            if (
                ...
                if (((g = []), 0 < CookieConsent.inlineConfiguration.Frameworks.IABTCF2.AllowedGoogleACVendors.length))
                    for (y = 0; y < this.googlePartnersSortedIds.length; y++)
                        0 <= CookieConsent.inlineConfiguration.Frameworks.IABTCF2.AllowedGoogleACVendors.indexOf(this.googlePartnersSortedIds[y]) && ((S = this.googlePartners[this.googlePartnersSortedIds[y]]), g.push(S.id));
            } else if ("object" == typeof CookieConsentIABCMP && CookieConsentIABCMP.GACMCommonList) {
                g = [];
                for (y = 0; y < this.googlePartnersSortedIds.length; y++) 0 <= CookieConsentIABCMP.GACMCommonList.indexOf(this.googlePartnersSortedIds[y]) && ((S = this.googlePartners[this.googlePartnersSortedIds[y]]), g.push(S.id));
            }
            for (y = 0; y < a.length; y++) {
                var p = this.IABGVL.purposes[a[y]];
                (l += "<div class='CybotCookiebotDialogBodyLevelButtonIABContainer'>"),
                    (l +=
                        "<div class='CybotCookiebotDialogBodyLevelButtonWrapper'><input type='checkbox' id='CybotCookiebotDialogBodyLevelButtonIABPurpose" +
                        p.id +
                        "' data-iabpurposeid='" +
                        p.id +
                        "' class='CybotCookiebotDialogBodyLevelButton CybotCookiebotDialogBodyIABButtonPurposes' checked='checked' tabindex='0'><label class='CybotCookiebotDialogBodyLevelButtonIABLabel' for='CybotCookiebotDialogBodyLevelButtonIABPurpose" +
                        p.id +
                        "'>" +
                        p.name +
                        "</label></div>"),
                    1 != p.id &&
                        (l +=
                            "<div class='CybotCookiebotDialogBodyLevelButtonWrapper'><input type='checkbox' id='CybotCookiebotDialogBodyLevelButtonIABPurposeLegitimateInterest" +
                            p.id +
                            "' data-iabpurposeid='" +
                            p.id +
                            "' class='CybotCookiebotDialogBodyLevelButton CybotCookiebotDialogBodyIABButtonPurposesLegitimateInterestSelection' checked='checked' tabindex='0'><label for='CybotCookiebotDialogBodyLevelButtonIABPurposeLegitimateInterest" +
                            p.id +
                            "'>" +
                    ...
                    (l +=
                        ...
                        p.descriptionLegal.replace("* ", '<ul class="CybotCookiebotDialogBodyLevelButtonIABBullet"><li>').replace(/\* /g, "</li><li>") +
                        "</li></ul></div>"),
                    (l += "</div>");
            }
            if (0 < r.length) {
                ...
                for (y = 0; y < r.length; y++) {
                    ...
                    (l += "<div class='CybotCookiebotDialogBodyLevelButtonIABContainer'>"),
                        ...
                        (l +=
                            "<div class='CybotCookiebotDialogBodyLevelButtonIABDescription'>" +
                            u.descriptionLegal.replace("* ", '<ul class="CybotCookiebotDialogBodyLevelButtonIABBullet"><li>').replace(/\* /g, "</li><li>") +
                            "</li></ul></div>"),
                        (l += "</div>");
                }
            }
            ...
            if (0 < d.length) {
                ...
                for (y = 0; y < d.length; y++) {
                    ...
                    (m += "<div class='CybotCookiebotDialogBodyLevelButtonIABContainer'>"),
                        ...
                        (m +=
                            "<div class='CybotCookiebotDialogBodyLevelButtonIABDescription'>" +
                            k.descriptionLegal.replace("* ", '<ul class="CybotCookiebotDialogBodyLevelButtonIABBullet"><li>').replace(/\* /g, "</li><li>") +
                            "</li></ul></div>"),
                        (m += "</div>");
                }
            }
            if (0 < c.length) {
                m +=
                    ...
                    "<span class='CybotCookiebotDialogBodyLevelButtonIABHeaderToggle'><a href='javascript: CookieConsentDialog.IABSelectFeatures()'>" +
                    this.IABResourceStrings.selectAll +
                    "</a> | <a href='javascript: CookieConsentDialog.IABDeselectFeatures()'>" +
                    this.IABResourceStrings.deselectAll +
                    "</a></span></div>";
                for (y = 0; y < c.length; y++) {
                    ...
                    (m += "<div class='CybotCookiebotDialogBodyLevelButtonIABContainer'>"),
                        (m +=
                            "<div class='CybotCookiebotDialogBodyLevelButtonWrapper'><input type='checkbox' id='CybotCookiebotDialogBodyLevelButtonIABFeature" +
                            b.id +
                            "' data-iabspecialfeatureid='" +
                            b.id +
                        ...
                        (m +=
                            "<div class='CybotCookiebotDialogBodyLevelButtonIABDescription'>" +
                            b.descriptionLegal.replace("* ", '<ul class="CybotCookiebotDialogBodyLevelButtonIABBullet"><li>').replace(/\* /g, "</li><li>") +
                            "</li></ul></div>"),
                        (m += "</div>");
                }
            }
            ...
            setTimeout(function () {
                var e;
                0 === a.length &&
                    (void 0 !== (e = document.getElementById("CybotCookiebotDialogDetailBodyContentIABv2TabPurposes")) &&
                        null != e &&
                        (B(e.getElementsByClassName("CybotCookiebotDialogBodyLevelButtonIABHeader")[0]),
                    ...
                    0 === c.length && (B(document.getElementById("CybotCookiebotDialogSpecialFeaturesText")), 0 === d.length && B(document.getElementById("CybotCookiebotDialogDetailBodyContentIABv2Features"))),
                    0 === a.length && 0 === r.length && 0 === d.length && 0 === c.length
                        ? CookieConsent.dialog.showCookieContainerIABv2DetailPane("partners")
                        : 0 === a.length && 0 === r.length && CookieConsent.dialog.showCookieContainerIABv2DetailPane("features");
            }, 1),
            ...
            D +=
                ...
                "<span class='CybotCookiebotDialogBodyLevelButtonIABHeaderToggle'><a href='javascript: CookieConsentDialog.IABSelectVendors()'>" +
                this.IABResourceStrings.selectAll +
                "</a> | <a href='javascript: CookieConsentDialog.IABDeselectVendors()'>" +
                this.IABResourceStrings.deselectAll +
                "</a></span></div>";
            for (y = 0; y < C.length; y++) {
                ...
                if (
                    ((D += "<div class='CybotCookiebotDialogBodyLevelButtonIABContainerCollapsed' id='CybotCookiebotDialogBodyLevelButtonIABVendorContainer" + S.id + "'>"),
                    (D +=
                        "<a title='" +
                        this.IABResourceStrings.expand +
                        "' class='CybotCookiebotDialogBodyLevelButtonIABContainerToggleShow' href='javascript: CookieConsentDialog.IABToggleContainer(\"CybotCookiebotDialogBodyLevelButtonIABVendorContainer" +
                        S.id +
                        "\")'></a>"),
                    (D +=
                        ...
                        "' data-iabvendorid='" +
                        S.id +
                        "' class='CybotCookiebotDialogBodyLevelButton CybotCookiebotDialogBodyIABButtonVendors' checked='checked' tabindex='0'><label class='CybotCookiebotDialogBodyLevelButtonIABLabel' for='CybotCookiebotDialogBodyLevelButtonIABVendor" +
                        S.id +
                        "'>" +
                        S.name +
                        "</label></div>"),
                    ...
                    L &&
                        (D +=
                            "<div class='CybotCookiebotDialogBodyLevelButtonWrapper'><input type='checkbox' id='CybotCookiebotDialogBodyLevelButtonIABVendorLegitimateInterest" +
                            S.id +
                            "' data-iabvendorid='" +
                            S.id +
                            "' class='CybotCookiebotDialogBodyLevelButton CybotCookiebotDialogBodyIABButtonVendorsLegitimateInterestSelection' checked='checked' tabindex='0'><label for='CybotCookiebotDialogBodyLevelButtonIABVendorLegitimateInterest" +
                            S.id +
                            "'>" +
                            this.IABResourceStrings.legitimateInterestHeader +
                            "</label></div>");
                ...
                if (
                    ...
                    (D += "<br>" + this.IABResourceStrings.purpose + " (" + this.IABResourceStrings.consent + "): "), (D += '<ul class="CybotCookiebotDialogBodyLevelButtonIABBullet">');
                    for (w = 0; w < I.length; w++) D += "<li>" + this.getIAB2PurposeById(I[w]) + "</li>";
                    D += "</ul>";
                }
                if (0 < v.length) {
                    (D += "<br>" + this.IABResourceStrings.purpose + " (" + this.IABResourceStrings.legitimateInterestHeader + "): "), (D += '<ul class="CybotCookiebotDialogBodyLevelButtonIABBullet">');
                    for (w = 0; w < v.length; w++) D += "<li>" + this.getIAB2PurposeById(v[w]) + "</li>";
                    D += "</ul>";
                }
                if (0 < T.length) {
                    (D += "<br>" + this.IABResourceStrings.specialPurpose + ": "), (D += '<ul class="CybotCookiebotDialogBodyLevelButtonIABBullet">');
                    for (w = 0; w < T.length; w++) D += "<li>" + this.getIAB2SpecialPurposeById(T[w]) + "</li>";
                    D += "</ul>";
                }
                if (0 < A.length) {
                    (D += "<br>" + this.IABResourceStrings.feature + ": "), (D += '<ul class="CybotCookiebotDialogBodyLevelButtonIABBullet">');
                    for (w = 0; w < A.length; w++) D += "<li>" + this.getIAB2FeatureById(A[w]) + "</li>";
                    D += "</ul>";
                }
                if (0 < E.length) {
                    (D += "<br>" + this.IABResourceStrings.specialFeature + ": "), (D += '<ul class="CybotCookiebotDialogBodyLevelButtonIABBullet">');
                    for (w = 0; w < E.length; w++) D += "<li>" + this.getIAB2SpecialFeatureById(E[w]) + "</li>";
                    D += "</ul>";
                }
                D += "</div></div>";
            }
                ...
                for (var S, y = 0; y < g.length; y++) {
                    (D += "<div class='CybotCookiebotDialogBodyLevelButtonIABContainerCollapsed CybotCookiebotDialogBodyGACMVendor' id='CybotCookiebotDialogBodyLevelButtonGoogleVendorContainer" + (S = this.googlePartners[g[y]]).id + "'>"),
                        (D +=
                            "<a title='" +
                            this.IABResourceStrings.expand +
                            "' class='CybotCookiebotDialogBodyLevelButtonIABContainerToggleShow' href='javascript: CookieConsentDialog.IABToggleContainer(\"CybotCookiebotDialogBodyLevelButtonGoogleVendorContainer" +
                            S.id +
                            "\")'></a>"),
                        (D +=
                            "<div class='CybotCookiebotDialogBodyLevelButtonWrapper'><input type='checkbox' id='CybotCookiebotDialogBodyLevelButtonGoogleVendor" +
                            S.id +
                            "' data-googlevendorid='" +
                            S.id +
                            "' class='CybotCookiebotDialogBodyLevelButton CybotCookiebotDialogBodyIABButtonVendors' checked='checked' tabindex='0'><label class='CybotCookiebotDialogBodyLevelButtonIABLabel' for='CybotCookiebotDialogBodyLevelButtonGoogleVendor" +
                            S.id +
                            "'>" +
                            S.name +
                            "</label></div>"),
                    ...
                    var O = [1, 2];
                    (D += "<br>" + this.IABResourceStrings.purpose + " (" + this.IABResourceStrings.consent + "): "), (D += '<ul class="CybotCookiebotDialogBodyLevelButtonIABBullet">');
                    for (w = 0; w < O.length; w++) D += "<li>" + this.getIAB2PurposeById(O[w]) + "</li>";
                    (D += "</ul>"), (D += "</div></div>");
                }
            }
        ...
        if (
            ((e.innerHTML = e.innerHTML.replace(/\[#COOKIETABLE_NECESSARY#]/g, this.getCookieTableHTML("Necessary", this.cookieTableNecessary, s, x))),
            ...
            if ("implied" == this.consentLevel && "undefined" == typeof CookieDeclaration)
                if ("-2" == this.cookieconsent.consentID) {
                    ...
                    document.referrer && 0 === document.referrer.indexOf(location.protocol + "//" + location.host) && (e = document.referrer), this.submitConsent(!0, e);
                } else {
                    if (void 0 === this.cookieconsent.getCookie(this.cookieconsent.name) && this.impliedConsentOnRefresh)
                        if (0 < this.cookieconsent.pathlist.length) for (var P = 0; P < this.cookieconsent.pathlist.length; P++) this.cookieconsent.setCookie("-2", null, this.cookieconsent.pathlist[P]);
    ...
    (CookieControl.Dialog.prototype.onscrollfunction = function (e) {
        if ("object" == typeof CookieConsentDialog) {
            if (CookieConsentDialog.isScrolling) {
                ...
                var o = 0;
                return (
                    window.pageYOffset ? (o = window.pageYOffset) : document.documentElement && document.documentElement.scrollTop ? (o = document.documentElement.scrollTop) : document.body && (o = document.body.scrollTop),
            ...
            !CookieConsentDialog.pageHasLoaded ||
                ...
                "object" == typeof CookieConsent &&
                    ...
                    150 <= Math.abs(e - window.CookieDialogInitScrollPosition) &&
    ...
    (CookieControl.Dialog.prototype.displaydialog = function () {
        ...
        (this.DOM.style.display = "none"),
            ...
            this.isInternalAlias &&
                (((t = document.createElement("div")).innerHTML = "TEST"),
        ...
        if (
            (this.DOM.addEventListener
                ? (this.DOM.addEventListener("mousewheel", o, !1), this.DOM.addEventListener("wheel", o, !1), this.DOM.addEventListener("DOMMouseScroll", o, !1), this.DOM.addEventListener("scroll", o, !1))
                : this.DOM.attachEvent && (this.DOM.attachEvent("onmousewheel", o, !1), this.DOM.attachEvent("wheel", o, !1), this.DOM.attachEvent("onscroll", o, !1)),
            "custom" != this.template)
        ) {
            if (
                ("" == this.title && (document.getElementById("CybotCookiebotDialogBodyContentTitle").style.display = "none"),
                ...
                if (((document.getElementById("CybotCookiebotDialogPoweredbyLink").style.display = "none"), "rtl" == this.textDirection))
                    switch (
                        ("overlay" == this.template || "popup" == this.template
                            ? ((document.getElementById("CybotCookiebotDialogBodyContent").style.paddingRight = "16px"),
                            ...
                            : ((document.getElementById("CybotCookiebotDialogBodyContent").style.paddingRight = "8px"),
                              "leveloptin" == this.responseMode
                                  ? (document.getElementById("CybotCookiebotDialogBodyLevelButtons").style.marginRight = "8px")
                                  : (document.getElementById("CybotCookiebotDialogBodyButtons").style.paddingRight = "0px")),
                    ...
                    switch (
                        ("overlay" == this.template || "popup" == this.template
                            ? ((document.getElementById("CybotCookiebotDialogBodyContent").style.paddingLeft = "16px"),
                              "leveloptin" == this.responseMode
                                  ? (document.getElementById("CybotCookiebotDialogBodyLevelButtons").style.marginLeft = "8px")
                                  : (document.getElementById("CybotCookiebotDialogBodyButtons").style.paddingLeft = "8px"))
                            : ((document.getElementById("CybotCookiebotDialogBodyContent").style.paddingLeft = "8px"),
                              "leveloptin" == this.responseMode
                                  ? (document.getElementById("CybotCookiebotDialogBodyLevelButtons").style.marginLeft = "8px")
                                  : (document.getElementById("CybotCookiebotDialogBodyButtons").style.paddingLeft = "0px")),
                        this.responseMode)
                    ) {
                        case "leveloptin":
            ...
            var n,
                ...
                a,
                r,
                o = document.getElementById("CybotCookiebotDialogBodyContentControls");
            null != o && (o.style.display = "none"),
                "optin" == this.responseMode
                    ? ((r = document.getElementById("CybotCookiebotDialogBodyButtonDecline")).style.display = "none")
                    ...
                    ? ((s = document.getElementById("CybotCookiebotDialogBodyButtonAccept")).style.display = "none")
                    : "leveloptin" == this.responseMode
                    ? ((document.getElementById("CybotCookiebotDialogBodyButtons").style.display = "none"),
                      ...
                      "allowselectdecline" == this.buttonMode || "allowallorselection" == this.buttonMode
                          ? (null != n && (n.style.display = "block"),
                            null != o && (o.style.display = "none"),
                            null !== (r = document.getElementById("CybotCookiebotDialogBodyLevelButtonLevelOptinDeclineAll")) && (r.style.display = "allowselectdecline" == this.buttonMode ? "" : "none"))
                          : (null != n && (n.style.display = "none"), null != o && (o.style.display = "block")),
                      ...
                      this.cookieconsent.hasFramework &&
                          ...
                          (l = document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing")) &&
        ...
        this.demomode || ("leveloptin" != this.responseMode && "inlineoptin" != this.responseMode && "custom" != this.template && "optionaloptin" != this.responseMode)
            ? !this.demomode ||
              ("leveloptin" != this.responseMode && "inlineoptin" != this.responseMode && "custom" != this.template) ||
              (document.getElementById("CybotCookiebotDialogBodyLevelButtonPreferences") && (document.getElementById("CybotCookiebotDialogBodyLevelButtonPreferences").checked = this.prechecked.preferences),
              ...
              document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing") &&
                  ((document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing").checked = this.prechecked.marketing),
                  this.cookieconsent.hasFramework &&
                      "iabv2" === this.cookieconsent.framework.toLowerCase() &&
                      !this.cookieconsent.frameworkBlocked &&
                      (this.consented || this.declined ? (this.consent.marketing ? this.IABSelectAll() : this.IABDeselectAll(!0)) : this.prechecked.marketing ? this.IABSelectAll() : this.IABDeselectAll(!0))))
            : void 0 !== (B = this.cookieconsent.getCookie(this.cookieconsent.name)) && CookieConsent && !CookieConsent.isNewVersion
            ? 0 == B.indexOf("{")
                ? ((a = B.replace(/%2c/g, ",")
                      .replace(/'/g, '"')
                  ...
                  "optionaloptin" == this.responseMode &&
                      document.getElementById("CybotCookiebotDialogBodyContentCheckboxPersonalInformation") &&
                      ((document.getElementById("CybotCookiebotDialogBodyContentCheckboxPersonalInformation").checked = !a.preferences && !a.statistics && !a.marketing),
                      this.cookieconsent.hasFramework &&
                          "iabv2" === this.cookieconsent.framework.toLowerCase() &&
                          !this.cookieconsent.frameworkBlocked &&
                          document.getElementById("CybotCookiebotDialogBodyContentCheckboxPersonalInformation").addEventListener("click", function () {
                ...
                ? (document.getElementById("CybotCookiebotDialogBodyLevelButtonPreferences") && (document.getElementById("CybotCookiebotDialogBodyLevelButtonPreferences").checked = !1),
                  ...
                  document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing") &&
                      ((document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing").checked = !1),
            ...
            "leveloptin" == i.responseMode
                ? (p &&
                          ...
                          function (e) {
                              (d.checked = !0),
                                  ...
                                  CookieConsent.dialog.cookieconsent.hasFramework &&
                                      "iabv2" === CookieConsent.dialog.cookieconsent.framework.toLowerCase() &&
                  ...
                  k &&
                      (k.addEventListener(
                          "click",
                          function (e) {
                              return i.submitDecline(e), !1;
                          },
                          !1
                      ),
                      k.focus()),
                  (y = document.getElementById("CybotCookiebotDialogBodyLevelButtonNecessary")) &&
                      y.parentNode.addEventListener(
                          "click",
                          function (e) {
                  ...
                  (y = document.getElementById("CybotCookiebotDialogBodyLevelDetailsWrapper")) &&
                      y.addEventListener(
                          "click",
                          function (e) {
                ...
                : "optionaloptin" == i.responseMode
                ? ((y = document.getElementById("CybotCookiebotDialogBodyButtonDetails")) &&
                      y.addEventListener(
                          "click",
                          function (e) {
                              return CookieConsent.dialog.toggleDetails(), !1;
                  ...
                  h &&
                      (h.addEventListener(
                          ...
                          function (e) {
                              ...
                              return t && t.checked && (o = !1), o ? i.submitConsent(!1) : i.submitDecline(e), !1;
                          },
                          !1
                      ),
                      h.focus()))
        ...
        switch ((B.initEvent("CookiebotOnDialogDisplay", !0, !0), window.dispatchEvent(B), (B = document.createEvent("Event")).initEvent("CookieConsentOnDialogDisplay", !0, !0), window.dispatchEvent(B), this.template)) {
            ...
            case "overlay":
                ...
                (f = this.DOM.offsetWidth), (f = Math.round((this.viewport.winWidth() - f) / 2 - 10));
                f < 0 && (f = 0),
                    (this.DOM.style.marginLeft = f + "px"),
                    "overlay" == this.template &&
                        (((f = document.createElement("div")).id = "CybotCookiebotDialogBodyUnderlay"),
        ...
        setTimeout(function () {
            i.setButtonsSize(), i.setZoomLevel();
        }, 50);
    }),
    ...
    (CookieControl.Dialog.prototype.createCustomScript = function (o) {
        if (!this.customScriptInitialized && ((this.customScriptInitialized = !0), null != (o = this.customTemplateDef.Script) && "" != o))
            if (window.execScript) window.execScript(o);
            else {
                var t = document.createElement("script");
                (t.type = "text/javascript"), (t.id = "CookiebotCustomScript");
                try {
                    t.appendChild(document.createTextNode(o)), document.body.appendChild(t);
                } catch (e) {
                    (t.text = o), document.body.appendChild(t);
                }
            }
    }),
    ...
    (CookieControl.Dialog.prototype.setZoomLevel = function () {
        ...
        if (null != i && "undefined" != i && "custom" != this.template && n) {
            ...
            if ((a < s || r < l) && ((e = r / (l + 0)), (o = a / (s + 0)), (t = Math.round(100 * Math.min(o, e)) / 100), 0.1 < e)) {
        ...
        if ("custom" != this.template) {
            ...
            switch (this.responseMode) {
                ...
                case "optout":
                    ...
                    break;
                case "optinout":
                    e && o && ((s = e.offsetWidth - 10), (l = o.offsetWidth - 10), (t = Math.max(s, l)), 0 < (t = Math.max(80, t)) && ((e.style.width = t + "px"), (o.style.width = t + "px")));
                    break;
                case "leveloptin":
                    ...
                    if (s) {
                        ...
                        var a = i.offsetWidth,
                            ...
                            s = c + 4,
                            C = !1;
                        if ((("overlay" != this.template && "popup" != this.template) || ((C = !0), (c = 24), (s = 28)), r < d + a + s))
                            try {
                            ...
                            "rtl" == this.textDirection ? (document.getElementById("CybotCookiebotDialogBodyLevelButtons").style.float = "right") : (document.getElementById("CybotCookiebotDialogBodyLevelButtons").style.float = "left"),
                                ...
                                C ||
                                    ((y = document.getElementById("CybotCookiebotDialogBodyContentText")) &&
                                        ((h = y.offsetWidth),
                                        (g = document.getElementById("CybotCookiebotDialogBodyLevelButtons")) &&
                                            (d + a + 4 <= h
                                                ? ((l = document.getElementById("CybotCookiebotDialogBodyContent").offsetWidth - h - 2),
                                                  (!this.showLogo || this.viewport.winWidth() <= this.autoHideLogoWidth) && (l += 2),
                                                  "rtl" == this.textDirection ? ((g.style.marginLeft = "0px"), (g.style.marginRight = l + "px")) : ((g.style.marginLeft = l + "px"), (g.style.marginRight = "0px")))
                                                : "rtl" == this.textDirection
                                                ? ((g.style.marginLeft = "0px"), (g.style.marginRight = "8px"))
                                                : ((g.style.marginLeft = "8px"), (g.style.marginRight = "0px")))));
                        }
                    }
                    ...
                    if (g) {
                        var p = y.offsetWidth - 10,
                            u = d.offsetWidth - 10;
                        (t = Math.max(p, u)), 0 < (t = Math.max(80, t)) && ((y.style.width = t + "px"), (d.style.width = t + "px"));
                        var m = C ? r - c : r - l;
                        try {
                            document.getElementById("CybotCookiebotDialogBodyLevelButtonsTable").style.width = m + "px";
                        } catch (e) {}
                    } else if (h) {
                        (p = y.offsetWidth - 10), (u = d.offsetWidth - 10), (h = a.offsetWidth - 10);
                        0 < (t = Math.max(80, p, u, h)) && ((y.style.width = t + "px"), (d.style.width = t + "px"), (a.style.width = t + "px"));
                        m = C ? r - c : r - l;
                        try {
                            document.getElementById("CybotCookiebotDialogBodyLevelButtonsTable").style.width = m + "px";
                        } catch (e) {}
    ...
    (CookieControl.Dialog.prototype.hide = function (e) {
        (this.visible = !1),
            document.getElementById(this.DOMid) &&
                ("custom" == this.template
                    ? this.runCustomScript(this.customTemplateDef.FunctionHideName, "hide")
                    : (this.fadeOut(), "pushdown" == this.template && document.body && (document.body.style.paddingTop = this.bodyPaddingTopInit + "px"))),
            e &&
                this.cookieconsent &&
                this.cookieconsent.hasFramework &&
                "iabv2" === this.cookieconsent.framework.toLowerCase() &&
    ...
    (CookieControl.Dialog.prototype.resize = function () {
        ...
        switch (this.template) {
            ...
            case "overlay":
                ...
                (t = Math.round((this.viewport.winHeight() - o) / 4)) < 0 && (t = 0), (this.DOM.style.marginTop = t + "px"), (this.DOM.style.marginLeft = "0px");
                var t = this.DOM.offsetWidth,
                    t = Math.round((this.viewport.winWidth() - t) / 2 - 10);
                t < 0 && (t = 0), (this.DOM.style.marginLeft = t + "px");
                t = document.getElementById("CybotCookiebotDialogBodyUnderlay");
                t && ((t.style.height = this.viewport.docHeight() + "px"), (t.style.width = this.viewport.docWidth() + "px"));
        }
        setTimeout(function () {
    ...
    (CookieControl.Dialog.prototype.pushDown = function () {
        ...
        (this.DOM.style.top = this.sliderPos - e + "px"),
            ...
            this.sliderPos < e
                ...
                : ((this.sliderPos = 0), document.body && (document.body.style.paddingTop = this.bodyPaddingTopInit + e + "px"), this.resize());
    }),
    (CookieControl.Dialog.prototype.slideUp = function () {
        ...
        (this.DOM.style.top = this.viewport.winHeight() - this.sliderPos + "px"),
            ...
            this.sliderPos < e
                ...
                : ((this.sliderPos = 0), (this.DOM.style.top = this.viewport.winHeight() - e + "px"), this.resize());
    }),
    (CookieControl.Dialog.prototype.fadeIn = function () {
        ...
        o &&
            (100 == this.faderPos &&
                (null != document.body.style.overflow && null != document.body.style.overflow && "" != document.body.style.overflow && (this.bodyOverflow = document.body.style.overflow), (document.body.style.overflow = "hidden")),
    ...
    (CookieControl.Dialog.prototype.fadeOut = function () {
        ...
        o && ((o.style.height = this.viewport.docHeight() + "px"), (o.style.display = "block"), (o.style.opacity = (this.faderPos - 20) / 100), (o.style.filter = "alpha(opacity=" + (this.faderPos - 30) + ")")),
            ...
            0 < this.faderPos
                ...
                : ((this.DOM.style.display = "none"), o && ((o.style.display = "none"), null != this.bodyOverflow ? (document.body.style.overflow = this.bodyOverflow) : (document.body.style.overflow = "auto")), (this.faderPos = 100));
    }),
    ...
    (CookieControl.Dialog.prototype.submitConsent = function (e, o, t) {
        ...
        o && 0 === o.indexOf(location.protocol + "//" + location.host) && (a = o),
            this.demomode ||
                ...
                ("leveloptin" != this.responseMode && "inlineoptin" != this.responseMode && "custom" != this.template) ||
                    ("object" == typeof CookieConsent.dialog.prechecked &&
                        "custom" != this.template &&
                        ((this.cookieconsent.consent.preferences = this.prechecked.preferences), (this.cookieconsent.consent.statistics = this.prechecked.statistics), (this.cookieconsent.consent.marketing = this.prechecked.marketing)),
                    document.getElementById("CybotCookiebotDialogBodyLevelButtonPreferences")
                        ...
                        : document.getElementById("CookieConsentDialogBodyLevelButtonPreferences") &&
                          (document.getElementById("CookieConsentDialogBodyLevelButtonPreferences").checked ? (this.cookieconsent.consent.preferences = !0) : (this.cookieconsent.consent.preferences = !1)),
                    document.getElementById("CybotCookiebotDialogBodyLevelButtonStatistics")
                        ...
                        : document.getElementById("CookieConsentDialogBodyLevelButtonStatistics") &&
                          (document.getElementById("CookieConsentDialogBodyLevelButtonStatistics").checked ? (this.cookieconsent.consent.statistics = !0) : (this.cookieconsent.consent.statistics = !1)),
                    document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing")
                        ? document.getElementById("CybotCookiebotDialogBodyLevelButtonMarketing").checked
                            ? (this.cookieconsent.consent.marketing = !0)
                            : (this.cookieconsent.consent.marketing = !1)
                        : document.getElementById("CookieConsentDialogBodyLevelButtonMarketing") &&
                          (document.getElementById("CookieConsentDialogBodyLevelButtonMarketing").checked ? (this.cookieconsent.consent.marketing = !0) : (this.cookieconsent.consent.marketing = !1)),
            ...
            this.demomode ||
                ...
                this.cookieconsent.hasFramework && this.cookieconsent.frameworkLoaded && "iabv2" === this.cookieconsent.framework.toLowerCase() && !this.cookieconsent.frameworkBlocked
                    ? window.__tcfapi("getTCData", 2, function (e) {
                          e.tcString ? (CookieConsent.IABConsentString = e.tcString) : (CookieConsent.IABConsentString = ""),
                              "object" == typeof CookieConsentIABCMP && CookieConsentIABCMP.encodeGACMString && e.addtlConsent
                                  ? (CookieConsent.GACMConsentString = CookieConsentIABCMP.encodeGACMString(e.addtlConsent))
    ...
    (CookieControl.Dialog.prototype.appendStyle = function (e) {
        ...
        i.setAttribute("type", "text/css"),
            ...
            "white" == this.theme
                ? ((this.customColors.background = "#ffffff"),
                  ...
                  (this.customColors.border = "#cccccc"))
                : "dark" == this.theme &&
                  ((this.customColors.background = "#161616"),
            ...
            "custom" != e &&
                (o = (o = (o = (o = (o = (o = (o = (o = (o = (o = (o = (o = (o = (o = (o = o.replace(/\#000001/g, this.customColors.background)).replace(/\#000002/g, this.customColors.text)).replace(
                    /\#000003/g,
                    this.customColors.acceptbutton
                )).replace(/\#000004/g, this.customColors.declinebutton)).replace(/\#000005/g, this.customColors.buttontext)).replace(/\#000006/g, this.customColors.tab)).replace(/\#000008/g, this.customColors.border)).replace(
                    /\#000009/g,
                    this.customColors.selectionbutton || this.customColors.acceptbutton
                )).replace(/url\(showdetails\.png\)/g, "url(" + this.customImages.showdetails + ")")).replace(/url\(hidedetails\.png\)/g, "url(" + this.customImages.hidedetails + ")")).replace(
                    /url\(CheckedNofocus\.png\)/g,
                    "url(" + this.customImages.cbCheckedNofocus + ")"
                )).replace(/url\(CheckedFocus\.png\)/g, "url(" + this.customImages.cbCheckedFocus + ")")).replace(/url\(CheckedDisabled\.png\)/g, "url(" + this.customImages.cbCheckedDisabled + ")")).replace(
                    /url\(NotCheckedFocus\.png\)/g,
                    "url(" + this.customImages.cbNotCheckedFocus + ")"
                )).replace(/url\(NotCheckedNoFocus\.png\)/g, "url(" + this.customImages.cbNotCheckedNoFocus + ")")),
    ...
    (CookieControl.Dialog.prototype.toggleDetails = function (e) {
        ...
        var o,
            t,
            i,
            n = document.getElementById("CybotCookiebotDialogDetail"),
            s = "leveloptin" == this.responseMode ? document.getElementById("CybotCookiebotDialogBodyLevelDetailsButton") : document.getElementById("CybotCookiebotDialogBodyButtonDetails"),
            l = new CookieControl.CSS(s);
        if (n) {
            switch (this.template) {
                case "top":
                case "slidedown":
                case "pushdown":
                    "block" == n.style.display
                        ? ((o =
                              "leveloptin" == this.responseMode
                                  ? (l.removeClass("CybotCookiebotDialogBodyLevelDetailsButtonExpanded"), document.getElementById("CybotCookiebotDialogBodyLevelButtonAccept"))
                                  : (l.removeClass("CybotCookiebotDialogBodyLinkExpanded"), document.getElementById("CybotCookiebotDialogBodyButtonAccept"))),
                          this.hideDetails(),
                          (s.innerHTML = this.showDetailsText),
                          o.focus())
                        : ((s.innerHTML = this.hideDetailsText),
            ...
            "inlineoptin" == this.responseMode
                ? "block" == n.style.display &&
                  ((i = document.getElementById("CybotCookiebotDialogDetailBodyContentCookieContainerTypes")),
                  0 < parseInt(i.clientHeight) && ((i.style.paddingTop = "0px"), (t = 170 - parseInt(i.clientHeight)), (i.style.paddingTop = t + "px")))
                : "block" == n.style.display &&
                  (((i = document.getElementById("CybotCookiebotDialogDetailBodyContentCookieContainerNecessary")).style.borderTop = "0px"),
    ...
    (CookieControl.Dialog.prototype.showCookieContainerIABv2DetailPane = function (e) {
        ...
        switch (e.toLowerCase()) {
            case "features":
                (n = document.getElementById("CybotCookiebotDialogDetailBodyContentIABv2Features")), (s = document.getElementById("CybotCookiebotDialogDetailBodyContentIABv2TabFeatures"));
                break;
            case "partners":
                (n = document.getElementById("CybotCookiebotDialogDetailBodyContentIABv2Partners")), (s = document.getElementById("CybotCookiebotDialogDetailBodyContentIABv2TabPartners"));
                break;
            default:
                (n = document.getElementById("CybotCookiebotDialogDetailBodyContentIABv2Purposes")), (s = document.getElementById("CybotCookiebotDialogDetailBodyContentIABv2TabPurposes"));
        }
    ...
    (CookieControl.Dialog.prototype.getIAB2SpecialPurposeById = function (e) {
        for (k in this.IABGVL.specialPurposes) if (this.IABGVL.specialPurposes[k].id == e) return this.IABGVL.specialPurposes[k].name;
        return "";
    }),
    ...
    (CookieControl.Dialog.prototype.getIAB2SpecialFeatureById = function (e) {
        for (k in this.IABGVL.specialFeatures) if (this.IABGVL.specialFeatures[k].id == e) return this.IABGVL.specialFeatures[k].name;
        return "";
    }),
    ...
    (CookieControl.Dialog.prototype.IABToggleContainer = function (e) {
        ...
        o &&
            (new CookieControl.CSS(o).toggleClass("CybotCookiebotDialogBodyLevelButtonIABContainer", "CybotCookiebotDialogBodyLevelButtonIABContainerCollapsed"),
            o.firstChild &&
                ((e = new CookieControl.CSS(o.firstChild)).toggleClass("CybotCookiebotDialogBodyLevelButtonIABContainerToggleShow", "CybotCookiebotDialogBodyLevelButtonIABContainerToggleHide"),
        ...
        (this.docHeight = function () {
            ...
            (this.docWidth = function () {
                ...
                return Math.max(
                    ...
                    e.innerWidth || t.clientWidth || i.clientWidth
                );
            }),
            ...
            (this.getPageScroll = function () {
                ...
                return (
                    self.pageYOffset
                        ? ((o = self.pageYOffset), (e = self.pageXOffset))
                        : document.documentElement && document.documentElement.scrollTop
                        ? ((o = document.documentElement.scrollTop), (e = document.documentElement.scrollLeft))
                        : document.body && ((o = document.body.scrollTop), (e = document.body.scrollLeft)),
                    [e, o]
                );
            }),
    ...
    (CookieControl.CSS.prototype.removeClass = function (e) {
        this.hasClass(e) && ((e = new RegExp("(\\s|^)" + e + "(\\s|$)")), (this.HTMLElement.className = this.HTMLElement.className.replace(e, " ")));
    }),
...
CookieConsentDialog.lastUpdatedDate = 1608030977100;
CookieConsentDialog.cookieTableNecessary = [
    ["__cfduid", "kido.school", "Used by the content network, Cloudflare, to identify trusted web traffic.", "29 days", "HTTP", "1", "", "kido.school"],
    ["CookieConsent", "kido.school", "Stores the user's cookie consent state for the current domain", "1 year", "HTTP", "1", "", "cookiebot.com"],
    ["PHPSESSID", "kido.school", "Preserves user session state across page requests.", "Session", "HTTP", "1", "^PHPSESSID.*$", "kido.school"],
    ["ASP.NET_SessionId", "web-in21.mxradon.com", "Preserves the visitor's session state across page requests.", "1 day", "HTTP", "1", "", "web-in21.mxradon.com"],
];
CookieConsentDialog.cookieTablePreference = [
    ["zoom", "kido.school", "Used in context with the website's map integration. The cookie stores user interaction with the map in order to optimize its functionality.", "Persistent", "HTML", "2", "", "kido.school"],
];
CookieConsentDialog.cookieTableStatistics = [
    ["_ga", "kido.school", "Registers a unique ID that is used to generate statistical data on how the visitor uses the website.", "2 years", "HTTP", "1", "", "www.googletagmanager.com"],
    [
        "_ga_#",
        "kido.school",
    ...
    ["_gat", "kido.school", "Used by Google Analytics to throttle request rate", "1 day", "HTTP", "1", "^_gat(_.+)*$", "www.googletagmanager.com"],
    ["_gid", "kido.school", "Registers a unique ID that is used to generate statistical data on how the visitor uses the website.", "1 day", "HTTP", "1", "", "www.googletagmanager.com"],
];
CookieConsentDialog.cookieTableAdvertising = [
    ...
    ["RUL", "doubleclick.net", "Used by DoubleClick to determine whether website advertisement has been properly displayed - This is done to make their marketing efforts more efficient.  ", "1 year", "HTTP", "1", "", "doubleclick.net"],
    ["test_cookie", "doubleclick.net", "Used to check if the user's browser supports cookies.", "1 day", "HTTP", "1", "", "doubleclick.net"],
    ["fr", "facebook.com", "Used by Facebook to deliver a series of advertisement products such as real time bidding from third party advertisers.", "3 months", "HTTP", "1", "", "facebook.com"],
    ...
    ["_fbp", "kido.school", "Used by Facebook to deliver a series of advertisement products such as real time bidding from third party advertisers.", "3 months", "HTTP", "1", "", "www.googletagmanager.com"],
    ["_gcl_au", "kido.school", "Used by Google AdSense for experimenting with advertisement efficiency across websites using their services.  ", "3 months", "HTTP", "1", "", "www.googletagmanager.com"],
    ...
    ["pagead/1p-conversion/#", "google.com", "Pending", "Session", "Pixel", "5", "", "www.google.ie"],
];
CookieConsentDialog.cookieTableUnclassified = [
    ["(unnamed)", "kido.school", "Pending", "Session", "HTTP", "1", "", "kido.school"],
    ["centresArray", "kido.school", "Pending", "Persistent", "HTML", "2", "", "kido.school"],
    ["citiesArray", "kido.school", "Pending", "Persistent", "HTML", "2", "", "kido.school"],
    ["ORG49973", "kido.school<br/>web-in21.mxradon.com", "Pending", "2 years", "HTTP", "1", "", "kido.school<br/>web-in21.mxradon.com"],
    ["singleCentreLocalization", "kido.school", "Pending", "Persistent", "HTML", "2", "", "kido.school"],
];
...
CookieConsent.whitelist = ["__cfduid", "CookieConsent", "PHPSESSID", "ASP.NET_SessionId"];
CookieConsentDialog.privacyPolicies = [
    ...
    ["googleads.g.doubleclick.net", "Google Inc.", "https://policies.google.com/privacy?hl=en"],
    ["www.facebook.com", "Facebook", "https://www.facebook.com/policies/cookies/"],
    ["www.google.ie", "Google", "https://policies.google.com/privacy"],
    ["www.googletagmanager.com", "Google Tag Manager", "https://policies.google.com/privacy"],
