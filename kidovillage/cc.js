...
CookiebotDialog = CookieConsentDialog = new CookieControl.Dialog(CookieConsent,'bottom_white','This website uses cookies','We use cookies in a limited way on our website, mainly for security and to analyse the traffic on our website. This analysis is done in an aggregated and anonymous manner. We do not share information about your use of our site with any external organisations.   ','Allow all cookies','Use necessary cookies only','leveloptin',false,false,'strict','en','Cookies are small text files that can be used by websites to make a user\'s experience more efficient.<br style="" /><br style="" />The law states that we can store cookies on your device if they are strictly necessary for the operation of this site. For all other types of cookies we need your permission.<br style="" /><br style="" />This site uses different types of cookies. Some cookies are placed by third party services that appear on our pages.<br style="" /><br style="" />You can at any time change or withdraw your consent from the Cookie Declaration on our website.<br style="" /><br style="" />Learn more about who we are, how you can contact us and how we process personal data in our Privacy Policy.<br style="" /><br style="" />Please state your consent ID and date when you contact us regarding your consent.','Necessary cookies help make a website usable by enabling basic functions like page navigation and access to secure areas of the website. The website cannot function properly without these cookies.','Preference cookies enable a website to remember information that changes the way the website behaves or looks, like your preferred language or the region that you are in.','Statistic cookies help website owners to understand how visitors interact with websites by collecting and reporting information anonymously.','Marketing cookies are used to track visitors across websites. The intention is to display ads that are relevant and engaging for the individual user and thereby more valuable for publishers and third party advertisers.','Unclassified cookies are cookies that we are in the process of classifying, together with the providers of individual cookies.','OK','Allow all cookies','Allow selection','allowselectdecline','Hide details','Show details');
...
CookieConsentDialog.lastUpdatedDate = 1608184094920;
CookieConsentDialog.cookieTableNecessary = [["CookieConsent", "kidovillage.com", "Stores the user\'s cookie consent state for the current domain", "1 year", "HTTP", "1", "", "cookiebot.com"], ["G_ENABLED_IDPS", "kidovillage.com", "Used for secure login to the website with a Google account.", "2914283 days", "HTTP", "1", "", "apis.google.com"], ["laravel_session", "kidovillage.com", "This cookie is used internally by the website’s owners, when uploading or renewing website content.", "1 day", "HTTP", "1", "", "kidovillage.com"], ["XSRF-TOKEN", "kidovillage.com", "Ensures visitor browsing-security by preventing cross-site request forgery. This cookie is essential for the security of the website and visitor.   ", "1 day", "HTTP", "1", "", "kidovillage.com"], ["ASP.NET_SessionId", "web-in21.mxradon.com", "Preserves the visitor\'s session state across page requests.", "1 day", "HTTP", "1", "", "web-in21.mxradon.com"]];
CookieConsentDialog.cookieTablePreference = [];
CookieConsentDialog.cookieTableStatistics = [["_ga", "kidovillage.com", "Registers a unique ID that is used to generate statistical data on how the visitor uses the website.", "2 years", "HTTP", "1", "", "kidovillage.com"], ["_ga_#", "kidovillage.com", "Used by Google Analytics to collect data on the number of times a user has visited the website as well as dates for the first and most recent visit. ", "2 years", "HTTP", "1", "^_ga_[A-Z0-9]{10}$", "kidovillage.com"], ["_gat", "kidovillage.com", "Used by Google Analytics to throttle request rate", "1 day", "HTTP", "1", "^_gat(_.+)*$", "kidovillage.com"], ["_gid", "kidovillage.com", "Registers a unique ID that is used to generate statistical data on how the visitor uses the website.", "1 day", "HTTP", "1", "", "kidovillage.com"]];
CookieConsentDialog.cookieTableAdvertising = [["IDE", "doubleclick.net", "Used by Google DoubleClick to register and report the website user\'s actions after viewing or clicking one of the advertiser\'s ads with the purpose of measuring the efficacy of an ad and to present targeted ads to the user.", "1 year", "HTTP", "1", "", "doubleclick.net"], ["test_cookie", "doubleclick.net", "Used to check if the user\'s browser supports cookies.", "1 day", "HTTP", "1", "", "doubleclick.net"], ["common/cavalry_endpoint.php", "facebook.com", "Collects data on visitor behaviour from multiple websites, in order to present more relevant advertisement - This also allows the website to limit the number of times that they are shown the same advertisement. ", "Session", "Pixel", "5", "", "www.facebook.com"], ["NID", "google.com", "Registers a unique ID that identifies a returning user\'s device. The ID is used for targeted ads.", "6 months", "HTTP", "1", "", "google.com"], ["VISITOR_INFO1_LIVE", "youtube.com", "Tries to estimate the users\' bandwidth on pages with integrated YouTube videos.", "179 days", "HTTP", "1", "", "youtube.com"], ["YSC", "youtube.com", "Registers a unique ID to keep statistics of what videos from YouTube the user has seen.", "Session", "HTTP", "1", "", "youtube.com"], ["yt-remote-cast-installed", "youtube.com", "Stores the user\'s video player preferences using embedded YouTube video", "Session", "HTML", "2", "", "youtube.com"], ["yt-remote-connected-devices", "youtube.com", "Stores the user\'s video player preferences using embedded YouTube video", "Persistent", "HTML", "2", "", "youtube.com"], ["yt-remote-device-id", "youtube.com", "Stores the user\'s video player preferences using embedded YouTube video", "Persistent", "HTML", "2", "", "youtube.com"], ["yt-remote-fast-check-period", "youtube.com", "Stores the user\'s video player preferences using embedded YouTube video", "Session", "HTML", "2", "", "youtube.com"], ["yt-remote-session-app", "youtube.com", "Stores the user\'s video player preferences using embedded YouTube video", "Session", "HTML", "2", "", "youtube.com"], ["yt-remote-session-name", "youtube.com", "Stores the user\'s video player preferences using embedded YouTube video", "Session", "HTML", "2", "", "youtube.com"], ["oauth2_cs::https://kidovillage.com::635289498946-6kbns8ll74bltma05stq1n4e3milqja1.apps.googleusercontent.com", "accounts.google.com", "Pending", "Session", "HTML", "2", "", "accounts.google.com"]];
CookieConsentDialog.cookieTableUnclassified = [["(unnamed)", "kidovillage.com", "Pending", "Session", "HTTP", "1", "", "kidovillage.com"], ["ORG50459", "kidovillage.com<br/>web-in21.mxradon.com", "Pending", "2 years", "HTTP", "1", "", "kidovillage.com<br/>web-in21.mxradon.com"]];
CookieConsentDialog.cookieTableNecessaryCount = 5;
CookieConsentDialog.cookieTablePreferenceCount = 0;
CookieConsentDialog.cookieTableStatisticsCount = 4;
CookieConsentDialog.cookieTableAdvertisingCount = 13;
CookieConsentDialog.cookieTableUnclassifiedCount = 3;
CookieConsent.whitelist = ['CookieConsent', 'G_ENABLED_IDPS', 'laravel_session', 'XSRF-TOKEN', 'ASP.NET_SessionId'];
CookieConsentDialog.privacyPolicies = [['accounts.google.com', 'Google', 'https://policies.google.com/privacy'], ['apis.google.com', 'Google', 'https://policies.google.com/privacy'], ['cookiebot.com', 'Cookiebot', 'https://www.cookiebot.com/goto/privacy-policy/'], ['doubleclick.net', 'Google', 'https://policies.google.com/privacy'], ['google.com', 'Google', 'https://policies.google.com/privacy'], ['www.facebook.com', 'Facebook', 'https://www.facebook.com/policies/cookies/'], ['youtube.com', 'YouTube', 'https://policies.google.com/privacy']];
